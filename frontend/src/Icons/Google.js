...
function GoogleIcon(props) {
  return (
    <svg width={32} height={32} {...props}>
      <defs>
        <rect id="google_svg__b" x={0} y={0} width={32} height={32} rx={2} />
        <rect id="google_svg__c" x={5} y={5} width={38} height={38} rx={1} />
        <filter
          x="-50%"
          y="-50%"
          width="200%"
      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(3 3)" filter="url(#google_svg__a)">
          <use fill="#4285F4" xlinkHref="#google_svg__b" />
          <use xlinkHref="#google_svg__b" />
          <use xlinkHref="#google_svg__b" />
          <use xlinkHref="#google_svg__b" />
        </g>
        <g transform="translate(-1 -1)">
          <use fill="#FFF" xlinkHref="#google_svg__c" />
